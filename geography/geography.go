...
// An Admin is a geographic administrative hierarchy.
type Admin struct {
	Country string // An ISO 3166-1 alpha-2 country code
	State   string // Principal administrative division, as a US-state
	County  string // Second administrative division
}
